...
const Item = ({ item }) => {
    ...
    return (
        <div className=" shadow-md rounded text-center">
            ...
            {quantity < 5 ? <>
                <p className="font-semibold text-yellow-400">In store:  {quantity} {type}</p>
                <RiDeleteBin6Line onClick={()=>handleDelete(_id)} className='text-center w-full text-lg text-red-400 my-2 cursor-pointer'/>
